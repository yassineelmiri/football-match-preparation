...
export const PlayerList: React.FC<PlayerListProps> = ({ players }) => {
  ...
  // Fonction pour ouvrir le popup d'update
  ...
  // Fonction pour enregistrer la mise à jour
                ...
                {(provided) => (
                  ...
                  >
                    <div className="flex items-center gap-2">
                      <img src={player.image} alt={`${player.prenom} ${player.nom}`} className="w-8 h-8 rounded-full" />
            ...
            >
              ...
              <div className="mb-2">
                ...
                <input
                  ...
                  onChange={(e) => setSelectedPlayer({ ...selectedPlayer })}
                  className="w-full p-2 border rounded"
                  required
                />
              </div>
